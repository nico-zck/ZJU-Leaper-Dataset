...
%    X   m by m matrix  
%  Description 
%    Performs the inverse AtA. This is an approximate inverse which 
%    uses a conjugate gradient solver. Each iteration uses
%    AtA_Toeplitz which is very fast as it merely involves 2 FFTs.  
% See Also
%   Inv_SeparateAngles, AtA_Toelplitz 
