...
[x,comps] = GenSignal('Bumps-LCosine',n);
xdct = comps(:,1);
xwav = comps(:,2);
...
dict1='LDCT';pars11=n/8;pars12=0;pars13=0;
...
options.inputdata = 'Input signal: Bumps + Local Cosines generated by GenSignal';
options
[ST,I] = dbstack;
...
% Display results.
figure;
set(gcf,'Name','MCA 1D Bumps + Local cosines','NumberTitle','off');
subplot(411);
