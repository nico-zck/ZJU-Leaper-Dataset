...
for p_id=1:5
    ...
    train_names = textread(['D:/Dataset/Dataset-Fabric/Fabric-Final/ImageSets/Patterns/p',int2str(p_id),'_train_unsupervised.txt'], '%s');
    num_train = length(train_names);

    % Input defect-free images
    for i=1:num_train
        image = imread(['D:/Dataset/Dataset-Fabric/Fabric-Final/Images/', train_names{i}, '.jpg']);
    ...
    % Testing stage start
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	test_names = textread(['D:/Dataset/Dataset-Fabric/Fabric-Final/ImageSets/Patterns/p',int2str(p_id),'_test.txt'], '%s');
    num_test = length(test_names);

    % Input defect-free images
    for i=1:num_test
        image = imread(['D:/Dataset/Dataset-Fabric/Fabric-Final/Images/', test_names{i}, '.jpg']);
...
%     end
    ...
    names = test_names;
    save(['ER_pattern', p_str ,'.mat'], 'results', 'names');
end
